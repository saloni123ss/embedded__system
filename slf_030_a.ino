...
void setup()
{
    ...
    delay(3000); // Reposition the robot on track if required. 
...
#define MAX_ALLOWED_SPEED      6375 //20000
#define MIN_ALLOWED_SPEED      2868 //9000

#define NUMBER_OF_ITERATIONS_PER_SECOND    50L
#define STOP_SIGN_MULTI_CHECK_SAMPLE_COUNT 10 //20
...
const int Kp =    250; // PID constants
const int Kd =    220;
const int Ki =    0;
